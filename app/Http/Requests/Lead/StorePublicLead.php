...
class StorePublicLead extends CoreRequest
{
    ...
    public function rules()
    {
        ...
        $rules = array();
        $rules['name'] = 'required';
        $rules['email'] = 'nullable|email:rfc|check_superadmin|unique:leads,client_email,null,id,company_id,' . $company->id.'|unique:users,email,null,id,company_id,' . $company->id;
