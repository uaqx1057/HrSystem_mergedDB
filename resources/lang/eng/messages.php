...
return array(
    ...
    'pendingTermination' => 'Employee added in pending termination successfully.',
    ...
    'reasonForAirTicketApproval' => 'Reason for air ticket approval',
    'reasonForAirTicketRejection' => 'Reason for air ticket rejection',
    'reasonForAdvanceSalaryApproval' => 'Reason for advance salary approval',
    'reasonForAdvanceSalaryRejection' => 'Reason for advance salary rejection',
    ...
    'qtyExceedsAvailable' => 'Quantity exceeds available quantity.',
    'assignmentAlreadyProcessed' => 'This assignment has already been processed.',
    'assignmentCannotDelete' => 'Approved assignments cannot be deleted. Please return the asset instead.',
    'returnQtyExceedsAssigned' => 'Return quantity exceeds the quantity assigned to this employee.',
    'serialCountMismatch' => 'The number of serial numbers must match the quantity.',
    'serialAlreadyExists' => 'Serial number ":serial" is already registered on another unit.',
    'serialNotAvailable' => 'That unit is not available for assignment.',
    'serialInUseCannotFlag' => 'This unit is currently reserved or issued to an employee and cannot be flagged. Return it first.',
    'qtyBelowInUse' => 'Quantity cannot be lower than the :count unit(s) that are reserved, issued or flagged.',
    'assetHasActiveAssignments' => 'This asset still has units assigned to employees. Return them before deleting.',
    'deleteSuccessWithSkipped' => 'Deleted. :count asset(s) were skipped because units are still assigned.',
    ...
    'confirmTerminate' => 'Yes, terminate it!',
    ...
    'terminateRecord' => 'You will not be able to recover the terminate record!',
    ...
    'acceptInviteError' => 'Invalid invitation. You are not authorised to sign up. Please use valid email.',
    'invalidAirticket' => 'You are not eligible for an Air Ticket request. Minimum one year of service is required',
