<div
    {{ $attributes->merge(['class' => 'form-heading-background p-20 rounded b-shadow-4 d-flex justify-content-between align-items-center']) }}>
    <div class="d-block text-capitalize">
        <h5 class="f-15 f-w-500 mb-20 text-darkest-white">{{ $title }}
            @if (!is_null($info))
