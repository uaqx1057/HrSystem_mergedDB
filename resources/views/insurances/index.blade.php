    ...
    <div class="content-wrapper">
        ...
        <div class="d-grid d-lg-flex d-md-flex action-bar">
            <div id="table-actions" class="flex-grow-1 align-items-center">
                @if (in_array(user()->permission('add_insurance'), ['all', 'added', 'branch']))
...
@push('scripts')
    ...
    <script>
        $('#insurances-table').on('preXhr.dt', function (e, settings, data) {
        ...
        const showTable = () => {
            window.LaravelDataTables["insurances-table"].draw(false);
        }
        ...
        const applyQuickAction = () => {
            const rowdIds = $("#insurances-table input:checkbox:checked").map(function () {
                return $(this).val();
            }).get();


            const url = "{{ route('insurance.apply_quick_action') }}?row_ids=" + rowdIds;
