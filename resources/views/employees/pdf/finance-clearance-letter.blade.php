...
<head>
    <meta charset="UTF-8">
    <title>Finance Clearance Letter - {{ $employee->name }}</title>
    <style>
    ...
    <div class="header">
        <table>
            <tr>
                ...
                <td class="doc-title">Finance Clearance Letter</td>
            </tr>
        </table>
    </div>
    ...
    <div class="container">
        <table class="info-table">
            ...
            <tr>
                ...
                <td>{{ $termination->financeClearanceIssuedBy->name ?? 'N/A' }}</td>
            </tr>
            <tr>
                <th>Clearance Issued On</th>
                <td>{{ optional($termination->finance_clearance_issued_at)->format('d-m-Y') }}</td>
            </tr>
        </table>

        <div class="declaration">
            This is to certify that <strong>{{ $employee->name }}</strong> has no outstanding advance salary or
            financial dues payable to the company. All financial obligations have been settled and verified by the
            Finance Department as part of the termination/offboarding process.
        </div>
