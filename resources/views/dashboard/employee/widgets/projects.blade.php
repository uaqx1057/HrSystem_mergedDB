@if (in_array('projects', $activeWidgets) && $sidebarUserPermissions['view_projects'] != 5 && $sidebarUserPermissions['view_projects'] != 'none' && in_array('projects', user_modules()))
    <div class="col-md-6 mb-3">
        <div
            class="{{ !user()->dark_theme ? 'e-card-d-info-light' : '' }} p-20 rounded b-shadow-4 d-flex justify-content-between align-items-center mt-3 mt-lg-0 mt-md-0">
            <div class="d-block text-capitalize">
                <h5 class="f-15 f-w-500 mb-20 text-darkest-white"> @lang('app.menu.projects') </h5>
                <div class="d-flex">
