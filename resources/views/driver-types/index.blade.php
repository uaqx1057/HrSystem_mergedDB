        ...
        <div class="d-flex justify-content-between action-bar">
            ...
            <div id="table-actions" class="d-block d-lg-flex align-items-center">
                ...
                @if ($addDriverPermission == 'all')
                    <x-forms.link-primary :link="route('driver-types.create')" class="mr-3 openRightModal" icon="plus">
                        @lang('app.addDriverType')
...
@push('scripts')
    ...
    <script>
        ...
        const showTable = () => {
            window.LaravelDataTables["driver-types-table"].draw(false);
        }
        ...
        $('body').on('click', '.delete-table-row', function () {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    var url = "{{ route('driver-types.destroy', ':id') }}";
